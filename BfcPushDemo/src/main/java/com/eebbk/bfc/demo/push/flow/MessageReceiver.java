...
public class MessageReceiver extends PushReceiver {
    ...
    public static final String MESSAGE_RECEIVER_ACTION ="com.eebbk.bfc.im_message_reciever_action";
    public static final String EXTRA_MESSAGE_NAME="extra_message";
    public static final String EXTRA_MESSAGE_RECEIVE_TIME_NAME="extra_message_receive_time";

    private static final int NOTIFY_ID=12131351;
...
//        intent.putExtra(EXTRA_MESSAGE_NAME,msg);
//        intent.putExtra(EXTRA_MESSAGE_RECEIVE_TIME_NAME, time);
    ...
    private void notification(Context context,String msg){
        ...
        mBuilder.setContentTitle("推送消息")//设置通知栏标题
                ...
                .setContentIntent(getDefalutIntent(context,msg)) //设置通知栏点击意图
    ...
    public PendingIntent getDefalutIntent(Context context,String msg){
