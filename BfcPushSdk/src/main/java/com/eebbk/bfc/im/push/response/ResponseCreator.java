...
public class ResponseCreator {
    ...
    public static Response createResponse(SyncApplication app, ResponseEntity responseEntity) {
        return new Response(app, responseEntity);
    }

    public static Response createTimeoutResponse(SyncApplication app, Request request) {
